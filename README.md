...
- **<h3>Design</h3>**
  ...
  - **Colour Scheme**
    ...
    The two main colours used are teal and dark orchid in the animated gradient background. This style was chosen for the background of the game
    to match the theme of the cards and the gradient was animated instead of originally going with a linear gradient in order to not completely
    blend in with the images on the back of the card.
